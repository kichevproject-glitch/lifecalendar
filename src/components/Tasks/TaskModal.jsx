...
export default function TaskModal({ task, date, categories, onSave, onDelete, onClose }) {
  ...
  const [reminderMinutes, setReminderMinutes] = useState(
    task?.reminder_minutes ? String(task.reminder_minutes) : ''
  )
      ...
      <div style={{ ...modal, borderTop: `4px solid ${priorityColor}` }} className="slide-in">
        ...
        <form onSubmit={handleSubmit} style={form}>
          ...
          <input
            ...
            placeholder="Task name..." style={inputLarge} autoFocus autoComplete="off"
          />
            ...
            <div style={{ display: 'flex', gap: 10, marginTop: 4, alignItems: 'center' }}>
              <div style={{ position: 'relative', flex: 1 }}>
                ...
                <input type="date" value={dueDate} onChange={e => setDueDate(e.target.value)}
                  style={{ ...input, paddingLeft: 32, marginTop: 0 }} />
              </div>
          ...
          <div>
            ...
            <div style={{ position: 'relative', marginTop: 4 }}>
              ...
              <select value={reminderMinutes} onChange={e => setReminderMinutes(e.target.value)}
                style={{ ...input, paddingLeft: 32, marginTop: 0, appearance: 'none', cursor: 'pointer' }}>
            ...
            {reminderMinutes && (
              <div style={reminderHint}>
                <span>✉️</span>
                <span>An email will be sent to your account address — {REMINDER_OPTIONS.find(r => r.value === reminderMinutes)?.label.toLowerCase()}</span>
              </div>
            )}
          </div>
